...
if(isset($_POST['applyEditDay']))
{
	...
	{
		$editSpecialDay->setName(mysql_real_escape_string($_POST['dayName']));
		$editSpecialDay->setDescription(mysql_real_escape_string($_POST['dayDescription']));
		$editSpecialDay->setColor(mysql_real_escape_string($_POST['dayColor']));
